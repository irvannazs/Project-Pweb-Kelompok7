    ...
    <div>
      ...
      >
        <div className="container">
          ...
          <p>
          Selamat datang di halaman Manajemen Mahasiswa. Untuk melanjutkan, harap isi kolom-kolom berikut dengan informasi yang diperlukan:
          </p>
          ...
          <form>
            ...
            <div className="form-row d-flex my-2">
              ...
              <div className="form-group col-md-4 mx-2">
                <label htmlFor="inputNPM">NPM</label>
                <input
                  name="NPM"
                  type="text"
                  className="form-control"
                  id="NPM"
                  value={studentFormData.NPM}
                  onChange={handleChange}
                />
              </div>
            </div>
